package com.minhdang.lab_tut01;
/**
...
public class DoubleLinkedList implements MyList {
  ...
  public void add(int index, int newValue) throws IndexOutOfBoundsException {
    ...
    if (mHead == null || index == 0) {
      ...
      if (index < Math.ceil((double) mLength / 2)) {
        currNode = mHead;
  ...
  public boolean remove(int value) {
    ...
    if (mHead.getValue() == value) {
      mHead = mHead.getNext();
      if (mHead != null) mHead.setPrev(null);
      else mTail = null;
      isRemoved = true;

    } else if (mTail.getValue() == value) {
      mTail = mTail.getPrev();
      mTail.setNext(null);
      isRemoved = true;
